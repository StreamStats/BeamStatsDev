...
function getData(){
    $.get('https://beam.pro/api/v1/channels/' + $('#inputText').val(), "", function(data){
         ...
         var Role = data['data']['user']['groups'];
         ...
         html += '<br><b><span class="label label-primary"style="color: black;">Level: ' + lvls +'</b>';
         html += '<br><b><span class="label label-primary"style="color: black;">Experience: ' + Experience +'</b>';
         html += '<br><b><span class="label label-primary"style="color: black;">Sparks: ' + Sparks +'</b></i>';
         html += '<br><b><span class="label label-warning">---ID---</b>'
         ...
         html += '<br><b><span class="label label-primary">SelfStreamMute:' + StreamMute +'</b>';
         html += '<br><b><span class="label label-primary">BeamBot FollowNotify:' + FollowNotify +'</b>';
         html += '<br><b><span class="label label-primary">BeamBot SubNotify:' + SubscribeNotify +'</b>';
         html += '<br><b><span class="label label-primary">TweetNotify:' + TweetNotify +'</b>';
         html += '<br><b><span class="label label-primary">Transcoding:' + te +'</b>';
         html += '<br><b><span class="label label-warning">------------</b>'
         html += "<br>";
         if(Online){
